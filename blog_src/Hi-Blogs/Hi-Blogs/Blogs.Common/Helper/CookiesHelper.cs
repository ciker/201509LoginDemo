...
namespace Blogs.Helper
{
    ...
    {
        /*
         * 创建：20150203  修改：20150203
         * 资料：
         * http://www.cnblogs.com/angells/archive/2009/12/05/1617681.html
         * http://www.cnblogs.com/cxd4321/archive/2008/11/14/1333696.html    主要看看 cookie 的 path 和 domain
         * 注意：  读取和操作cookie是不一样的
         * 1.读取 主要用  HttpRequest  
         * 2.操作 增删改用HttpResponse
         */
        ...
        public static void SetCookie(string cookieName, string key, string value, DateTime? expires)
        {
            ...
            if (response != null)
            {
                HttpCookie cookie = GetCookie(cookieName); // response.Cookies[cookieName];
                if (cookie != null)
                {
                    if (!string.IsNullOrEmpty(key) && cookie.HasKeys)
