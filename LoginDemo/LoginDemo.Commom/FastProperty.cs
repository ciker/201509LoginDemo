...
namespace LoginDemo.Commom
{
    ...
    {
        private delegate void SetPropertyHandler();

        public void IlSetPropertyHandler()
        {
            //得到新类型
            ...
            //var dynamicMethod = new DynamicMethod("SetProperty", typeof(T), new[] { typeof(T) });

            //var constructor = typeof(T).GetConstructors(BindingFlags.Public | BindingFlags.Instance | BindingFlags.Default);//default construction
            // var ILGenerator = dynamicMethod.GetILGenerator();
            //var setProperty= dynamicMethod.MakeGenericMethod(typeof (T));

            //typeof(T).GetProperties()[0].Name
            //ILGenerator.Emit();
        }
